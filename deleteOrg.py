...
def delete_company_structure_by_id(cursor, department_id):
    cursor.execute("DELETE FROM company_structure WHERE id = %s", (department_id,))

# API endpoint for deleting data from company_structure
@app.route('/api/company_structure/delete/<department_id>', methods=['DELETE'])
